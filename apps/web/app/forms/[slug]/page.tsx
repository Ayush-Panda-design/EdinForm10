  ...
  if (isLoading) return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-stone-950 to-slate-900">
      <div className="text-center space-y-4">
        <div className="w-12 h-12 border-3 border-stone-400/30 border-t-stone-800 rounded-full animate-spin mx-auto" />
      ...
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-stone-600 text-white font-semibold hover:bg-stone-500 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
          >
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-stone-950 to-slate-900 flex flex-col">
      {form.showProgressBar && (
        <div className="h-1 bg-white/5">
          <div className="h-1 bg-foreground w-0 transition-all duration-700" />
        </div>
      )}
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-16">
        <div className="max-w-xl w-full text-center space-y-6">
          ...
          <div className="pt-4 flex flex-col items-center gap-4">
            <button
              onClick={handleNext}
              className="group inline-flex items-center gap-3 px-8 py-4 bg-white text-slate-900 rounded-2xl font-semibold text-lg hover:bg-stone-50 transition-all shadow-2xl  hover: hover:scale-105 active:scale-100"
            >
              Start
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-stone-950 to-slate-900 flex flex-col">
      ...
      {form.showProgressBar && (
        <div className="h-1 bg-white/5 flex-shrink-0">
          <div
            className="h-1 bg-foreground transition-all duration-700 ease-out"
        ...
        <div className="w-full max-w-xl space-y-6">
          ...
          <div className="flex items-center gap-3 pt-2">
            <button
              ...
              className="inline-flex items-center gap-2 px-7 py-3.5 bg-stone-600 hover:bg-stone-500 text-white rounded-xl font-semibold transition-all disabled:opacity-50 shadow-lg  hover: hover:scale-105 active:scale-100"
            >
