...
export default function DashboardPage() {
  ...
  const stats = [
    { label: "Total Forms", value: dashboard?.totalForms ?? 0, icon: FileText, bg: "bg-stone-50 dark:bg-stone-900/20", color: "text-stone-600 dark:text-stone-400" },
    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/dashboard/forms/new"
          className="flex items-center gap-2 bg-foreground text-white px-5 py-2.5 rounded-xl font-medium hover:opacity-90 transition-opacity shadow-lg  dark:">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800">
        <div className="p-5 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between">
          ...
          <Link href="/dashboard/forms/new" className="text-sm text-stone-600 dark:text-stone-400 hover:underline font-medium">
            + Create new
          </Link>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="p-12 text-center">
            <div className="w-16 h-16 rounded-2xl bg-foreground dark:from-stone-900/20 dark:to-stone-900/20 flex items-center justify-center mx-auto mb-4">
            ...
            <Link href="/dashboard/forms/new"
              className="inline-flex items-center gap-2 bg-stone-600 text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-stone-700 transition-colors">
          ...
          <div className="divide-y divide-gray-100 dark:divide-gray-800">
            {forms?.map((form) => (
              <div key={form.id} className="p-4 flex items-center gap-4 hover:bg-gray-50/50 dark:hover:bg-gray-800/30 transition-colors">
                <div className="w-10 h-10 rounded-xl bg-foreground dark:from-stone-900/30 dark:to-stone-900/30 flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    <Link href={"/dashboard/forms/" + form.id + "/edit"}
                      className="font-medium text-gray-900 dark:text-white hover:text-stone-600 dark:hover:text-stone-400 truncate transition-colors">
                      {form.title}
                    </Link>
                ...
                <div className="flex items-center gap-1 flex-shrink-0">
                  ...
                  {form.visibility !== "unpublished" && (
                    <button
                      ...
                      className="p-2 text-gray-400 hover:text-stone-600 dark:hover:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-900/20 rounded-lg transition-colors"
                      title="Share QR">
