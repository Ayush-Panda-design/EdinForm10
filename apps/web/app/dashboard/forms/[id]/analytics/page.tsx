...
export default function FormAnalyticsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const stats = [
    ...
    { label: "Submissions", value: analytics?.totalSubmissions ?? 0, icon: FileText, color: "text-stone-600" },
  ...
  return (
    <div className="max-w-5xl mx-auto">
      ...
      {isLoading ? (
        <div className="flex justify-center p-16"><Loader2 className="w-6 h-6 animate-spin text-stone-600" /></div>
      ) : (
