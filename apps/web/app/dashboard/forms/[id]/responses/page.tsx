      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {responsesData?.data.map((response, idx) => (
            <div key={response.id} className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 p-5 hover:border-stone-200 dark:hover:border-stone-800 transition-colors">
