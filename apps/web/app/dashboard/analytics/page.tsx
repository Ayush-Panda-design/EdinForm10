  ...
  if (isLoading) {
    return (
      <div className="flex justify-center items-center p-32">
        <Loader2 className="w-10 h-10 animate-spin text-stone-600 dark:text-stone-400" />
      </div>
    );
  }
          ...
          {([7, 30, 90] as const).map((days) => (
            <button
              ...
              className={`px-3 py-1.5 text-xs font-semibold rounded-lg transition-all duration-200 ${
                daysFilter === days
                  ? "bg-white dark:bg-gray-800 text-stone-600 dark:text-stone-400 shadow-sm"
        ...
        {stats.map((s) => (
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-stone-50 dark:bg-stone-950/30 flex items-center justify-center mb-4">
              <s.icon className="w-5 h-5 text-stone-600 dark:text-stone-400" />
            </div>
          ...
          <div className="space-y-4 flex-1">
            {topForms.length > 0 ? (
              topForms.map((form, idx) => (
                <div
                  key={form.id}
                  className="flex items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-gray-950 border border-gray-100 dark:border-gray-800 hover:border-stone-300 dark:hover:border-stone-800 transition-colors"
                >
                  <div className="min-w-0 flex-1 pr-3">
                    <div className="flex items-center gap-2">
                      <span className="text-xs font-bold text-stone-600 dark:text-stone-400 bg-stone-100 dark:bg-stone-950/50 px-2 py-0.5 rounded">
                        #{idx + 1}
                      </span>
                  ...
                  <Link
                    ...
                    className="p-2 bg-white dark:bg-gray-900 hover:bg-stone-50 dark:hover:bg-stone-950/30 rounded-lg text-gray-500 hover:text-stone-600 dark:hover:text-stone-400 border border-gray-150 dark:border-gray-800 transition-colors shadow-sm"
                  >
              ...
              >
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  ...
                  <Link
                    ...
                    className="p-1.5 rounded-lg text-gray-400 hover:text-stone-600 dark:hover:text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-950/30 transition-colors opacity-0 group-hover:opacity-100"
                  ...
                  >
                    ...
                    <td className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div className="w-16 h-1.5 bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden hidden sm:block">
                          <div
                            className="h-full bg-stone-600 dark:bg-stone-400 rounded-full"
                    ...
                    <td className="p-4 pr-6 text-right">
                      <div className="flex justify-end gap-2">
                        ...
                        <Link
                          href={`/dashboard/forms/${form.id}/analytics`}
                          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold bg-stone-50 hover:bg-stone-100 text-stone-700 dark:bg-stone-950/30 dark:hover:bg-stone-950/60 dark:text-stone-300 rounded-lg transition-colors border border-stone-100/20"
                        >
                          Full Analytics
                        </Link>
                      </div>
