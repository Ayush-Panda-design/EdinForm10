...
export function ConditionalLogicEditor({
  ...
  const handleUpdate = (
    ...
    onChange({
      showIf: {
        ...
        operator: newOperator as NonNullable<ConditionalLogic["showIf"]>["operator"],
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={`relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none ${
            enabled ? "bg-stone-600" : "bg-gray-200 dark:bg-gray-700"
          }`}
        >
          <span
      ...
      {enabled && (
        <div className="pl-4 border-l-2 border-stone-200 dark:border-stone-800 space-y-3">
          ...
          {sourceFieldId && (
            <div className="flex items-start gap-2 p-2.5 rounded-lg bg-stone-50 dark:bg-stone-900/20 border border-stone-100 dark:border-stone-800/50">
              <Zap className="w-3.5 h-3.5 text-stone-500 flex-shrink-0 mt-0.5" />
