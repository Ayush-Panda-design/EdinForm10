          ...
          <label
            ...
            className={`flex items-center gap-3 cursor-pointer p-4 rounded-xl border-2 transition-all ${
              strVal === opt.value
                ...
                : "border-gray-200 dark:border-gray-700 hover:border-stone-300 dark:hover:border-stone-700"
            ...
            >
              <div
                className={`w-5 h-5 rounded-lg border-2 flex items-center justify-center flex-shrink-0 transition-colors ${
                  selected ? "bg-stone-600 border-stone-600" : "border-gray-300 dark:border-gray-600"
                }`}
                onClick={() => {
                  if (readOnly) return;
